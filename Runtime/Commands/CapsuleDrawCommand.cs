...
public class CapsuleDrawCommand : DrawCommandBase
{
    ...
    public override List<PackedDrawCommand> ToDrawCommands(int objID, float tolerance = 0.001f)
    {
        // filled capsule: thickness ignored by shader
        PackedDrawCommand cmd = new PackedDrawCommand(PackedDrawCommand.CMD_CAPSULE, endpointA, endpointB, Vector2.zero, color, radius, 0.0f, objID);
        cmd.objectID = objID;
