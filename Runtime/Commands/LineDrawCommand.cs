...
public class LineDrawCommand : DrawCommandBase
{
    ...
    public override List<PackedDrawCommand> ToDrawCommands(int objID, float tolerance = 0.001f)
    {
        PackedDrawCommand _line = new PackedDrawCommand(PackedDrawCommand.CMD_LINE, start, end, Vector2.zero, color, 0, thickness, objID);
        _line.objectID = objID;
        return new List<PackedDrawCommand> { _line };
    }
}
*/