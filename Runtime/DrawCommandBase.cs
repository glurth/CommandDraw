...
public struct PackedDrawCommand
{
    ...
    public const int CMD_ARC = 1;
    public const int CMD_DISK = 2;
    public const int CMD_RECT = 3; // axis-aligned filled rect
    public const int CMD_ORECT = 4; // oriented filled rect
    public const int CMD_RRECT = 5; // rounded filled rect
    public const int CMD_CAPSULE = 6;
    public const int CMD_TRIANGLE = 7;


    public Vector2 start;           // LINE:   endpoint A
                                    // ARC:    center
                                    // DISK:   center
                                    // RECT:   center
                                    // ORECT:  center
    ...
    public Vector2 end;             // LINE:   endpoint B
    ...
    public Vector2 thirdCorner;     // LINE:   (ignored)
                                    // ARC:    (ignored)
                                    // DISK:   (ignored)
                                    // RECT:   (ignored)
                                    // ORECT:  (ignored)
    ...
    public Color color;
    public float thickness; // stroke thickness for stroked shapes; ignored for filled
    public int commandType;
    public int objectID;
...
public abstract class DrawCommandBase
{
    public abstract void InitializeData(Vector2Int pixelSize); // pass Vector2Int.zero or Vector2Int.one for UV based
    public abstract List<PackedDrawCommand> ToDrawCommands(int objID, float tolerance = 0.001f);
